...
def train(args, dataset):
    ...
    model = ProMIAF(seq_feature_matrix.shape[1], text_feature_matrix.shape[1], struct_feature_matrix.shape[1], args.n_hidden, label_matrix.shape[1],
    ...
    for epoch in range(args.n_epochs):
        ...
        if fmax_ > best_fmax:
            ...
            best_fmax = fmax_
            torch.save(model.state_dict(), os.path.join(args.model_dir, F"ProMIAF_{args.ontology}_{args.model_id}.ckp"))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='train ProMIAF model.')
    ...
    logger.info("Running the training script for ProMIAF model.")
