...
def main(args):
    ...
    logger.info(F'Evaluate ProMIAF model.')
    ...
    pred_matrix = get_pred_matrix(os.path.join(result_dir, F'{ont}_prediction_ProMIAF_{args.model_id}.txt'), pid2index, go2index)
    ...
    with open('/root/autodl-tmp/ProMIAF-master/result/log_d.txt', 'a') as f:  # 'a'表示追加模式
        f.write(F'{ont}_prediction_ProMIAF_{args.model_id}\n')
